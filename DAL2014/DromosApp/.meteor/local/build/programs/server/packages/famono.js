...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                         //
// packages/famono/requirejs_server.js                                                                     //
//                                                                                                         //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                           //
require = function () {                                                                                    // 1
  throw new Error('Famous "require" cannot run on the server');                                            // 2
}                                                                                                          // 3
                                                                                                           // 4
define = function () {                                                                                     // 5
  throw new Error('Famous "define" cannot run on the server');                                             // 6
};                                                                                                         // 7
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                         //
// packages/famono/requirejs_libraries_server.js                                                           //
//                                                                                                         //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                           //
...
if (!fs.existsSync(famonoLibFolder)) {                                                                     // 17
  console.log('Famono: Error lib folder not found "' + famonoLibFolder + '"');                             // 18
} else {                                                                                                   // 19
  ...
  try {                                                                                                    // 22
    ...
    throw new Error('Famono: Error could not parse .config json, ' + err.message);                         // 25
  }                                                                                                        // 26
                                                                                                           // 27
  for (var ns in config) {                                                                                 // 28
    try {                                                                                                  // 29
      ...
      console.log('Famono: Error namespace config load failed "' + ns + '"');                              // 32
    }                                                                                                      // 33
  }                                                                                                        // 34
                                                                                                           // 35
}                                                                                                          // 36
...
WebApp.connectHandlers.use(function(req, res, next) {                                                      // 69
  ...
  if (/^\/lib\//.test(req.url)) {                                                                          // 71
    if (!config) {                                                                                         // 72
      ...
      res.end('Famono: Error registry not found in "' + famonoRepoFolder + '"');                           // 76
    } else {                                                                                               // 77
      ...
      if (currentNS) {                                                                                     // 90
        ...
        if (currentNS[name]) {                                                                             // 99
          ...
          if (found) {                                                                                     // 148
            ...
            res.end('Famono: Error, did you mean "' + found.key + '" instead of "' + found.name + '"?');   // 150
          } else {                                                                                         // 151
            // If no config loaded then report as an error                                                 // 152
            res.end('Famono: Error, library not found in "' + name + '"');                                 // 153
          }                                                                                                // 154
        }                                                                                                  // 155
                                                                                                           // 156
      } else {                                                                                             // 157
        ...
        res.end('Famono: Error namespace not found "' + namespace + '"');                                  // 161
      }                                                                                                    // 162
    }                                                                                                      // 163
                                                                                                           // 164
  } else {                                                                                                 // 165
